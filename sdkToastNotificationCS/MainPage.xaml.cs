...
namespace sdkToastNotificationCS
{
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        private void register(String key)
        {
            String id = key;
            String phoneType = "WP";
            String phoneOwner = "aida.taps";

            StringBuilder postData = new StringBuilder();
            postData.AppendFormat("{0}={1}", "id", HttpUtility.UrlEncode(id));
            postData.AppendFormat("&{0}={1}", "phoneType", HttpUtility.UrlEncode(phoneType));
            postData.AppendFormat("&{0}={1}", "phoneOwner", HttpUtility.UrlEncode(phoneOwner));
